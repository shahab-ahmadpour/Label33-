...
public static class BrandText
{
    private static readonly Dictionary<string, Dictionary<string, string>> Map = new(StringComparer.OrdinalIgnoreCase)
    {
        ["fa"] = new()
        {
            ...
            ["hero.support"] = "۳۳ — نگاهی متفاوت به لباس‌های روزمره.",
            ...
            ["about.title"] = "درباره ۳۳",
            ["about.body"] = "لباس قرار نیست همه را یک شکل کند. ۳۳ درباره ذهن‌های متفاوتی است که یک جهان را جور دیگر می‌بینند.",
            ["diyar.title"] = "آشنایی با دیار",
            ["diyar.intro"] = "دیار نماد بصری ۳۳ است؛ آزاد، کنجکاو، سازگار و متمایز.",
            ["cart.title"] = "سبد خرید",
